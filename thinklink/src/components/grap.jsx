    ...
    return <div className={styles.main_overview}>
                ...
                <div className={styles.chart_data}>
                    ...
                    <div style={{marginLeft:'50px'}}>
                        ...
                        <h3>$12,545.00</h3>
                        <div className={styles.data_week}>
                        <img width="25px" height='25px' src="https://store-images.s-microsoft.com/image/apps.26602.13977111684761394.0bfe3d3f-121c-48a5-90a1-fd5f3f8a6484.b1cdaa65-f278-4f9c-b6fa-fc7fda795165"/><label>23% from last week</label>
                        </div>

                        <label style={{color:"grey",fontSize:"17px",fontWeight:'bold'}}>Total Product Sold<h4 style={{color:"grey",fontSize:"17px",}}>329</h4></label>
                    </div>
                </div>
